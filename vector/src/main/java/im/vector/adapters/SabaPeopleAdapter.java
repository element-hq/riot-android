...
public class SabaPeopleAdapter extends AbsAdapter {
    ...
    private String mNoContactAccessPlaceholder;
    ...
    public SabaPeopleAdapter(final Context context,
...
//        addSection(mKnownContactsSection);
    ...
    SabaPeopleAdapter(Context context, RoomInvitationListener invitationListener, MoreRoomActionListener moreActionListener) {
        super(context, invitationListener, moreActionListener);
    }

    // these followings are for roomAdapter
