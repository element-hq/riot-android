...
public class NotificationPrivacyActivity extends RiotAppCompatActivity  {
    ...
    public void initUiAndData() {
        ...
        rlyNormalPrivacy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                setNotificationPrivacy(NotificationPrivacyActivity.this, PushManager.NotificationPrivacy.NORMAL);
                refreshNotificationPrivacy();
            }
        });
        ...
        rlyLowDetailNotifications.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                setNotificationPrivacy(NotificationPrivacyActivity.this, PushManager.NotificationPrivacy.LOW_DETAIL);
                refreshNotificationPrivacy();
            }
        });
        ...
        rlyReducedPrivacy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                setNotificationPrivacy(NotificationPrivacyActivity.this, PushManager.NotificationPrivacy.REDUCED);
                refreshNotificationPrivacy();
            }
        });
    }
    ...
    private void refreshNotificationPrivacy() {
        PushManager pushManager = Matrix.getInstance(this).getSharedPushManager();

        switch (pushManager.getNotificationPrivacy()) {
            case REDUCED:
     ...
     */
    static public void setNotificationPrivacy(Activity activity, PushManager.NotificationPrivacy notificationPrivacy) {
        PushManager pushManager = Matrix.getInstance(activity).getSharedPushManager();

        // first, set the new privacy setting
        pushManager.setNotificationPrivacy(notificationPrivacy);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M
                && notificationPrivacy == PushManager.NotificationPrivacy.NORMAL) {
     ...
     * @return a string
     */
    static public String getNotificationPrivacyString(Context context, PushManager.NotificationPrivacy notificationPrivacy) {
