...
public class PreferencesManager {
    ...
    public static final String SETTINGS_ACKNOWLEDGEMENT_PREFERENCE_KEY = "SETTINGS_ACKNOWLEDGEMENT_PREFERENCE_KEY";
    ...
    public static final String SETTINGS_NON_EDITABLE_DISPLAY_NAME_PREFERENCE_KEY = "SETTINGS_NON_EDITABLE_DISPLAY_NAME_PREFERENCE_KEY";
    ...
    public static final String SETTINGS_SEND_TYPING_NOTIF_KEY = "SETTINGS_SEND_TYPING_NOTIF_KEY";
    ...
    public static final String SETTINGS_SHOW_READ_RECEIPTS_KEY = "SETTINGS_SHOW_READ_RECEIPTS_KEY";
    ...
    // media
    public static final String SETTINGS_MEDIA_CATEGORY_PREFERENCE_KEY = "SETTINGS_MEDIA_CATEGORY_PREFERENCE_KEY";
    public static final String SETTINGS_DEFAULT_MEDIA_COMPRESSION_KEY = "SETTINGS_DEFAULT_MEDIA_COMPRESSION_KEY";
    public static final String SETTINGS_DEFAULT_MEDIA_SOURCE_KEY = "SETTINGS_DEFAULT_MEDIA_SOURCE_KEY";
    public static final String SETTINGS_PREVIEW_MEDIA_BEFORE_SENDING_KEY = "SETTINGS_PREVIEW_MEDIA_BEFORE_SENDING_KEY";
    public static final String SETTINGS_PLAY_SHUTTER_SOUND_KEY = "SETTINGS_PLAY_SHUTTER_SOUND_KEY";
    ...
    // Calls
    public static final String SETTINGS_CALL_CATEGORY_PREFERENCE_KEY = "SETTINGS_CALL_CATEGORY_PREFERENCE_KEY";
    ...
    public static final String SETTINGS_CALL_CATEGORY_DIVIDER_PREFERENCE_KEY = "SETTINGS_CALL_CATEGORY_DIVIDER_PREFERENCE_KEY";
    ...
    //Integrations
    public static final String SETTINGS_INTEGRATION_ALLOW_CATEGORY_KEY = "SETTINGS_INTEGRATION_ALLOW_CATEGORY_KEY";
    public static final String SETTINGS_INTEGRATION_ALLOW_CATEGORY_DIVIDER_KEY = "SETTINGS_INTEGRATION_ALLOW_CATEGORY_DIVIDER_KEY";
    ...
    public static final String SETTINGS_DEACTIVATE_ACCOUNT_CATEGORY_KEY = "SETTINGS_DEACTIVATE_ACCOUNT_CATEGORY_KEY";
