...
package org.matrix.vector.adapters;
...
import org.matrix.vector.activity.ImageSliderActivity;
import org.matrix.vector.activity.MemberDetailsActivity;
    ...
    @Override
        ...
        if (null != fileMessage.url) {
            ...
            if (null != mediaFile) {
                ...
                CommonActivityUtils.openMedia(VectorApplication.getCurrentActivity(), savedMediaPath, fileMessage.getMimeType());
            }
        }
    }
