...
import org.matrix.vector.adapters.DrawerAdapter;
...
public class MXCActionBarActivity extends ActionBarActivity {
    ...
    protected void onPause() {
        super.onPause();
        VectorApplication.setCurrentActivity(null);

        ((VectorApplication)getApplication()).startActivityTransitionTimer();
    ...
    protected void onResume() {
        super.onResume();
        VectorApplication.setCurrentActivity(this);
        ...
        ((VectorApplication)getApplication()).stopActivityTransitionTimer();
    }
    @Override
