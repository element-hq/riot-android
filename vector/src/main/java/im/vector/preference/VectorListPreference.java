...
public class VectorListPreference extends ListPreference {
    ...
    private int mWarningIconVisibility = View.GONE;
    ...
    protected View onCreateView(ViewGroup parent) {
        ...
        mWarningIconView.setVisibility(mWarningIconVisibility);
    ...
    public void setWarningIconVisibility(int visibility) {
        mWarningIconVisibility = visibility;
