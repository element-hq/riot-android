...
public class RingtoneUtils {
    ...
    public static Uri getCallRingtoneUri() {
        String callRingtone = preferences.getString(context.getResources().getString(R.string.notification_sounds_settings_ringtone), null);
        if (callRingtone == null) { // Use current system notification sound for calls if never set in riot
    ...
    public static void setCallRingtoneUri(Uri ringtoneUri) {
        ...
        editor.putString(context.getResources().getString(R.string.notification_sounds_settings_ringtone), ringtoneUri.toString());
        editor.commit();
    }
