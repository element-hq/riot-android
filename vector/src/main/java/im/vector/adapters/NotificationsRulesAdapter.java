...
public class NotificationsRulesAdapter extends ArrayAdapter<BingRule> {
    ...
    public interface NotificationClickListener {
        void onAddWordRule(String word, Boolean alwaysNotify, Boolean playSound, Boolean highlight);
        void onAddRoomRule(Room room, Boolean alwaysNotify, Boolean playSound, Boolean highlight);
        void onAddSenderRule(String sender, Boolean alwaysNotify, Boolean playSound, Boolean highlight);

        void onToggleRule(BingRule rule);
        void onRemoveRule(BingRule rule);
    }
