...
/**
 * Copy of PatternsCompat with a simple modification to web url autolink pattern in order to accept trailing slash
 * as part of url.
...
object VectorAutoLinkPatterns {
    ...
    private val SIMPLE_WORD_END_BOUNDARY = "(?:\\b|(?=\\s)|$)"
     ...
     * defined in RFC5321: #&~!^`{}/=$*?|
     */
    private val EMAIL_CHAR = "$LABEL_CHAR\\+\\-_%'"
     ...
     */
    private val EMAIL_ADDRESS_LOCAL_PART =
     ...
     */
    private val EMAIL_ADDRESS_DOMAIN = "(?=.{1,255}(?:\\s|$|^))$HOST_NAME"
    ...
    private val EMAIL_WITHOUT_MAILTO = "(" + WORD_BOUNDARY +
            "(?:" + EMAIL_ADDRESS_LOCAL_PART + "@" + EMAIL_ADDRESS_DOMAIN + ")" +
            WORD_BOUNDARY + ")"

    private val EMAIL_WITH_MAILTO = "(" + WORD_BOUNDARY +
            "(?:mailto:)" +
            "(?:" + EMAIL_ADDRESS_LOCAL_PART + "@" + EMAIL_ADDRESS_DOMAIN + ")" +
            WORD_BOUNDARY + ")"


    val AUTOLINK_EMAIL = Pattern.compile(
            "($EMAIL_WITH_MAILTO|$EMAIL_WITHOUT_MAILTO)")
